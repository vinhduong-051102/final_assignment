...
const Login = () => {
    ...
    const schema = object({
        email: string().required("Email không được để trống").test('', 'Email không đúng định dạng', value => {
                                ...
                                render={({field}) => {
                                    ...
                                    return (
                                        <div style={{position: "relative"}}>
                                            ...
                                            {
                                                isError &&
                                                <span style={{position: "absolute", bottom: -25, left: 5, color: 'rgb(234,43,43)'}}>
