...
export const getSuggestWordSuccess = createAction(constants.GET_SUGGEST_WORD_SUCCESS)

export const getSuggestMeaning = createAction(constants.GET_SUGGEST_MEANING_ACTION)
