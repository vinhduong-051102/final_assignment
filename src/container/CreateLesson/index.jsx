...
const CreateLesson = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (result) {
            if (listCard.length >= 3) {
                ...
                alert("Phải có ít nhất 3 từ để tạo bài học")
            }
        }
    ...
    const schema = object({
        ...
        description: string().required("Mô tả không được để trống").max(255, "Mô tả tối đa 255 ký tự"),
    })
                                    ...
                                    render={({field}) => {
                                        ...
                                        return (
                                            <div style={{position: "relative"}}>
                                                ...
                                                {
                                                    isError &&
                                                    <span style={{position: "absolute", bottom: -25, left: 5, color: 'rgb(234,43,43)', fontWeight: 700}}>
